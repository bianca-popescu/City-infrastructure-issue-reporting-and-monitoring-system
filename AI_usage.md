...
Functions generated with AI assistance:
    ...
    remove_report: used to remove a report from reports.dat binary file, used AI-generated logic as a starting point for the shifting logic using lseek and ftruncate.
    get_permissions_string: used to convert mode_t bits to a human-readable string, used AI to better understand permission bits, groups and their importance.
